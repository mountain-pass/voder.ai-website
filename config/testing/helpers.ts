...
export interface ComponentWithMount {
  mount?: (container: HTMLElement) => void | Promise<void>;
  unmount?: () => void | Promise<void>;
  update?: (props: any) => void | Promise<void>;
  updateConfig?: (props: any) => void | Promise<void>;
}
  ...
  return {
    ...
    update: async (props) => {
      if (typeof component?.updateConfig === 'function') {
        await component.updateConfig(props);
...
/**
 * Simulate a keypress event on an element
 */
