...
- **REQ-FOLLOW-DOCS**: Development should follow the documentation in docs/libraries/ for proper usage patterns, configuration, and best practices for each dependency
