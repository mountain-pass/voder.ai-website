...
- [x] **Floating Motion**: Segment 1 continuously floats with camera bobbing effect (emerging from fog metaphor)
- [x] **Ethereal Glow**: "Magic" word receives brand teal glow when visible; "fast" and "exciting" get teal color shifts
...
- **REQ-GENTLE-MOTION**: Continuous floating motion using time-based translateY transforms (camera bobbing effect)
- **REQ-WARM-GLOW**: Brand teal (#22c7be) glow effects on magic-related and speed-related words
...
- **REQ-SEGMENT-1**: "Remember when AI coding felt like magic?"
  ...
  - Continuous camera bobbing effect (like on a boat) using time-based animation
  - "Magic" word gets brand teal glow when segment becomes visible
  - Subtle scale pulse during floating motion
...
- **REQ-SEGMENT-2**: "When shipping features was fast and exciting?"
  - Dramatic 400px slide in from left with easeOutBack momentum
